...
Future<void> analyzeSchedule(List<TaskModel> tasks) async {
  ...
  try {
    ...
    Your job is to analyze these tasks, identify any overlaps conflicts in their start and end times,
    ...
    Ensure the markdown is well formatted and easy to read. Do not include extra text outside pf these headers.
''';
