...
class AiScheduleService extends ChangeNotifier {
  ...
  final String _apiKey = 'AIzaSyCtzIEXO4kEEEYsWUWq2hw3ucW51KGxCbI';
  ...
  Future<void> analyzeSchedule(List<TaskModel> tasks) async {
    ...
    try {
      ...
      final prompt = '''
        ...
        You are an expert student scheduling assistent. The user has provided the following tasks for their day in JSON format: $tasksJson(String Interpolation)
